 ...
 )
{
    ...
    {  
     ...
     color_similarity_r = abs_diff((int)(100 * left_pixel.x), (int)(100 * right_pixel.x));
     color_similarity_g = abs_diff((int)(100 * left_pixel.y), (int)(100 * right_pixel.y));
     color_similarity_b = abs_diff((int)(100 * left_pixel.z), (int)(100 * right_pixel.z));
